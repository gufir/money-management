...
// Source: github.com/gufir/money-management/worker (interfaces: TaskDistributor)
...
import (
	...
	worker "github.com/gufir/money-management/worker"
...
func (m *MockTaskDistributor) DistributeTaskResetPassword(arg0 context.Context, arg1 *worker.PayloadSendForgotPassword, arg2 ...asynq.Option) error {
	m.ctrl.T.Helper()
