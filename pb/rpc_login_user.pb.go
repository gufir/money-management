...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"user.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"v\n" +
	"\x10LoginUserRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12*\n" +
	"\x11is_email_verified\x18\x03 \x01(\bR\x0fisEmailVerified\"\xb1\x02\n" +
	"\x11LoginUserResponse\x12\x1c\n" +
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04user\x12\x0e\n" +
	...
	"\x18refresh_token_expired_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiredAtB&Z$github.com/gufir/money-management/pbb\x06proto3"
